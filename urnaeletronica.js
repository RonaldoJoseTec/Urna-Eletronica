function urnaeletronica() {
    ...
    let contador = 0;
    let senha ;
    senha = prompt('Digite a senha de segurança')
    ...
    do {
        ...
        } else if(opcao != 1,2,3,5,8) {
            alert('opção inválida !')
            function confirm('pffff')
        }
    } while (decisao !== 'S');
    ...
    console.log('percentual de votos em branco ', ((branco / totaldevotos).toFixed(2)) * 100 +'%');
    console.log('relação de votos nulos', nulo);
    console.log('percentual de votos nulos', ((nulo / totaldevotos).toFixed(2)) * 100 +'%');
