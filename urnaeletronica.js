...
async function urnaeletronica() {
    ...
    if (contadorDeVotos > 0) {
        ...
        console.log('relação do candidato', nome4[1], candidato4);
        console.log('percentual de votos do candidato5', ((candidato5 / contadorDeVotos * 100).toFixed(2)) + '%');
        console.log('relação do candidato', nome5[1], candidato5);
